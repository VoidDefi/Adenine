...
{
    internal class ReadKeyCharProtein : FunctionalProtein
    {
        public override string Name => "read-key-char";
        ...
        public override void Invoke(float value, ref ProgramRunModifier modifier)
        {
            ...
            VirtualMachine.Cell.Proteins[index] = Console.ReadKey().KeyChar;
        }
    }
}
